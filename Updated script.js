const recipes = [
  {
    ...
    description: "Crispy beef tacos with melted cheese and consommé for dipping.",
    cost: "£3.50",
    time: "35 mins",
    rating: "★★★★☆",
    hotPick: false,
    ingredients: "Tortillas, shredded beef, mozzarella, onions, coriander, consommé",
    instructions: "Fill tortillas with beef and cheese. Fry until crispy, then serve with hot consommé for dipping."
  },
  {
    title: "Rasta Pasta",
    image: "https://images.unsplash.com/photo-1621996346565-e3dbc646d9a9?auto=format&fit=crop&w=900&q=80",
    description: "Creamy Caribbean-inspired pasta with jerk chicken and peppers.",
    cost: "£3.80",
    time: "25 mins",
    rating: "★★★★☆",
    hotPick: false,
    ingredients: "Pasta, jerk chicken, cream, parmesan, mixed peppers",
    instructions: "Cook pasta. Fry jerk chicken and peppers, add cream and parmesan, then mix everything together."
  },
  {
    title: "Loaded Nachos",
    image: "https://images.unsplash.com/photo-1513456852971-30c0b8199d4d?auto=format&fit=crop&w=900&q=80",
    description: "Crunchy nachos loaded with melted cheese, salsa and jalapeños.",
    cost: "£2.50",
    time: "10 mins",
    rating: "★★★★☆",
    hotPick: false,
    ingredients: "Nachos, cheddar cheese, salsa, jalapeños, sour cream",
    instructions: "Bake nachos with cheese until melted. Add salsa, jalapeños and sour cream before serving."
  },
  {
    title: "BBQ Beef Burger",
    image: "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?auto=format&fit=crop&w=900&q=80",
    description: "Juicy beef burger with BBQ sauce, cheese and crispy onions.",
    cost: "£3.40",
    time: "18 mins",
    rating: "★★★★☆",
    hotPick: false,
    ingredients: "Burger bun, beef patty, BBQ sauce, cheese, crispy onions",
    instructions: "Cook the beef patty. Toast the bun, then assemble with cheese, BBQ sauce and crispy onions."
  },
  {
    title: "Loaded Fries",
    image: "https://images.unsplash.com/photo-1576107232684-1279f390859f?auto=format&fit=crop&w=900&q=80",
    description: "Golden fries topped with chicken, melted cheese and garlic mayo.",
    cost: "£2.70",
    time: "15 mins",
    rating: "★★★★☆",
    hotPick: false,
    ingredients: "Fries, chicken, cheddar cheese, garlic mayo, spring onions",
    instructions: "Cook the fries. Add chicken and cheese, melt under the grill, then drizzle with garlic mayo."
  },
  {
    title: "Smash Burger",
    image: "https://images.unsplash.com/photo-1550547660-d9450f859349?auto=format&fit=crop&w=900&q=80",
    description: "Double smashed beef patties with melted cheese and burger sauce.",
    cost: "£3.60",
    time: "20 mins",
    rating: "★★★★☆",
    hotPick: false,
    ingredients: "Burger buns, minced beef, American cheese, lettuce, pickles, burger sauce",
    instructions: "Smash beef patties on a hot pan. Add cheese, toast the buns and assemble with lettuce, pickles and sauce."
  },
  {
    title: "Pesto Pasta",
